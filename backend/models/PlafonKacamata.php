...
class PlafonKacamata extends \yii\db\ActiveRecord
{
    ...
    /**
     * @inheritdoc
     * @return \backend\models\queries\PlafonKacamataQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \backend\models\queries\PlafonKacamataQuery(get_called_class());
    }
}
