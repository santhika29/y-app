...
class StatusPeserta extends \yii\db\ActiveRecord
{
    ...
    /**
     * @inheritdoc
     * @return \backend\models\queries\StatusPesertaQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \backend\models\queries\StatusPesertaQuery(get_called_class());
    }
}
